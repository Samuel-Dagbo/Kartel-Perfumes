  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-ivory to-mist/30 flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-1/2 translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-b from-gold/[0.03] via-transparent to-transparent rounded-full blur-3xl" />
        <div className="absolute top-20 right-10 w-64 h-64 border border-gold/5 rounded-full" />
        <div className="absolute bottom-20 left-10 w-96 h-96 border border-gold/5 rounded-full" />
        <div className="absolute top-1/2 right-1/3 w-px h-32 bg-gradient-to-b from-transparent via-gold/10 to-transparent" />
        <div className="absolute top-1/3 left-1/4 w-px h-24 bg-gradient-to-b from-transparent via-gold/10 to-transparent" />
      </div>
      ...
      >
        <div className="text-center mb-10">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <p className="text-sm text-charcoal/40">Create your account</p>
            <div className="w-4 h-px bg-gold/30" />
          </div>
        </div>
